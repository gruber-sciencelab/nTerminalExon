...
QSUB_DEFAULTS = "-cwd -V"
CLUSTER_CONFIG = "../../configs/sge-config.yaml"
...
def format_job_properties(string):
    ...
    # snakemake option
    string = string.replace("params.LOG_cluster_log", "placeholder")
    return string.format(rulename=job_properties['rule'], jobid=job_properties['jobid'], placeholder=job_properties['params']["LOG_cluster_log"])
